...
import { Profile_Form }         from  '/imports/client/ui/components/customer/PUsers/profile-form/index.jsx'
...
class Profile_Page extends React.Component {
	...
	componentWillUnmount() {
		// transfer any changes from here to app.user_record
		//this.props.store.app.update__user_record(this.puserManager.record) 
