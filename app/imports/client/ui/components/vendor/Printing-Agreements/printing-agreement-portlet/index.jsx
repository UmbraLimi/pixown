...
// ----styles-----------------------
import { Printing_Agreement_Portlet_ } 		from  './styles.js'
// ----helpers----------------------
...
@inject('store')
@observer
class Printing_Agreement_Portlet extends React.Component {
  ...
  handleNewButtonWasClicked = () => {
    ...
    store.router.goTo(app_routes.vendor_printingagreement, settings, store, {})
  }
  ...
  render() {
    const	{ ready, message, problem, paManager } = this.props
		if (!ready) { return <Loading  message={message} problem={problem}/> }
   	// -> -> -> -> //

    return (
      <Printing_Agreement_Portlet_   className='Printing_Agreement_Portlet_' >
        <Portlet
            Manager={paManager}
            title='Printing Agreement Details'
        ...
        />
      </Printing_Agreement_Portlet_>
    )
	}
}
// ====================================================================

export { Printing_Agreement_Portlet }
