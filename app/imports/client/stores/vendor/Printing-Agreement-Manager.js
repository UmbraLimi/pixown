...
// ----collections------------------
import { Printing_Agreements } 	from  '/imports/collections/Printing-Agreements/collection'
// ----components-------------------

// ========================================================================
class Printing_Agreement_Manager {
	
	constructor(store, {source, content, Form_Content, notifyStore}) {
		this.__name = 'Printing_Agreement_Manager'
		this.store = store 
		...
		this.spec = {
			...
			name: 'PRINTING_AGREEMENTS.composite.one-mongo-id',
...
// ========================================================================
	...
	export { Printing_Agreement_Manager }